...
export const PropertyDetailsFeature = ({ data }: {
    data: {
        ...
        <PropertyDetailsContainer>
            ...
            >
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <Typography variant="body2" fontWeight={"semiBold"}>Interior Details</Typography>
                    </Grid>
                    {
                    ...
                    <Grid item xs={12}>
                        <Typography variant="body2" fontWeight={"semiBold"}>Outdoor Details</Typography>
                    </Grid>
                    {
                    ...
                    <Grid item xs={12}>
                        <Typography variant="body2" fontWeight={"semiBold"}>utilities Details</Typography>
                    </Grid>
                    {
                    ...
                    <Grid item xs={12}>
                        <Typography variant="body2" fontWeight={"semiBold"}>Other Features</Typography>
                    </Grid>
                    {
